...
int GetMemoryTrainingTableIndex() {
    if (const int dram_id = fuse_read_dramid(false); dram_id < (int) sizeof(MemoryTrainingTableIndices) && MemoryTrainingTableIndices[dram_id] != MemoryTrainingTableIndex_Invalid) {
