...
extern void (*nyx_vol_up_action)(void);
extern void (*nyx_vol_down_action)(void);
extern void (*nyx_jc_plus_action)(void);
extern void (*nyx_jc_minus_action)(void);
extern void (*nyx_jc_a_action)(void);
extern void (*nyx_jc_b_action)(void);
extern void (*nyx_jc_b_long_action)(void);
extern void (*nyx_jc_x_action)(void);
extern void (*nyx_jc_y_action)(void);
extern void (*nyx_jc_l_action)(void);
extern void (*nyx_jc_zl_action)(void);
extern void (*nyx_jc_r_action)(void);
extern void (*nyx_jc_zr_action)(void);
extern void (*nyx_jc_r3_action)(void);
extern void (*nyx_jc_dpad_action)(int dir);
extern bool nyx_jc_dpad_mode;
extern bool nyx_jc_kb_repeat;
//==================================
...
//============================================================
//  Advanced Option save, dram train toggle. (gui_options.c)
//============================================================
